...
import bchat.utilities.GroupUsersListRenderer;
 ...
 * @author Blacky
 */
public class ViewGroupUsersFrame extends javax.swing.JInternalFrame {
    ...
    public ViewGroupUsersFrame(int groupId) {
        try {
            initComponents();
...
//            ArrayList<Integer> groupMembersIds = MainUser.proxy.getGroupUsersIDs(this.groupId);
    ...
    private void initComponents() {
        ...
        usersJlist.setToolTipText("View Members");
        ...
        viewAddMembers.setText("View Members");
